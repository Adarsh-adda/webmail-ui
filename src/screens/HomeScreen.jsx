...
const HomeScreen = () => {
  ...
  const inactive = "flex justify-center items-center space-x-2";
  return (
    <div className="bg-slate-900 h-screen px-6 sm:px-12 text-white">
      <div className="flex flex-col sm:flex-row sm:p-6 p-2 gap-3">
        ...
        <div className="flex flex-col sm:w-[80vw] w-full sm:border border  border-slate-500 rounded-lg sm:p-6 p-2">
